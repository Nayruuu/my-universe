...
- 1,225 unit and integration tests plus 64 static-data, documentation, and deployment tests;
...
- 61 end-to-end Chromium journeys across desktop and mobile viewports.
