...
describe('paquets de tuiles stellaires', () => {
  ...
  it.each([
    ...
    { ...validTile(), sourceIds: undefined },
    { ...validTile(), sourceIds: ['123', '123'] },
    { ...validTile(), sourceIds: ['123', 'not-a-gaia-id'] },
    {
      ...validTile(),
  ...
  it.each([
    ...
    [{ representation: 'aggregate-cell', sourceIds: undefined }, 'représentation'],
    [
      {
        sourceStarCount: 2,
