...
export interface TempelFilamentSpineCatalog {
  ...
  readonly filamentIds: Uint16Array;
  readonly pointOffsets: Uint32Array;
  readonly positionsMpc: Float32Array;
  readonly visitMap: Uint8Array;
  readonly density: Uint8Array;
  readonly orientationStrength: Uint8Array;
}
...
export async function loadTempelFilamentSpineCatalog(
  ...
  return parseTempelFilamentSpineCatalog(await response.arrayBuffer());
}
...
function decodeFilamentIndex(
  ...
  filamentCount: number,
  pointCount: number,
): { readonly filamentIds: Uint16Array; readonly pointOffsets: Uint32Array } {
