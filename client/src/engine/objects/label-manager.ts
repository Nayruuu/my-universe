...
export class LabelManager {
  ...
  private wheelTargetId: string | null = null;
  private width = 1;
  private height = 1;
  ...
  public setWheelTargetObject(objectId: string | null): void {
    if (objectId === this.wheelTargetId) {
      return;
    }
    this.wheelTargetId = objectId;
    this.lastRenderTime = Number.NEGATIVE_INFINITY;
  }
  ...
  public render(
    ...
    for (const candidate of candidates) {
      ...
      const wheelTarget = candidate.object.id === this.wheelTargetId;
