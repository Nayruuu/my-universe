...
export class SpaceStreamingCoordinator {
  ...
  public get stats(): SpaceStreamingStats {
    return {
      ...
      activeStarTiles: this.starTiles?.activeTileCount ?? 0,
      cachedStarPacks: this.starTiles?.cachedPackCount ?? 0,
      cachedStarTiles: this.starTiles?.cachedTileCount ?? 0,
      activeStarClusters: this.starTiles?.activeClusterCount ?? 0,
      cachedStarClusters: this.starTiles?.cachedClusterCount ?? 0,
    };
  }
