...
describe('UniverseEngine', () => {
  ...
  it('branche le catalogue dense et tous les adaptateurs entre contrôles et moteur', async () => {
    ...
    const supportsCatalogWheelNavigation = vi
      .spyOn(access.catalogRuntime!, 'supportsWheelNavigation')
      .mockImplementation((objectId) => objectId === 'hyg-3229');
    ...
    expect(selection.isWheelNavigationObject('sun')).toBe(true);
    expect(selection.isWheelNavigationObject('hyg-3229')).toBe(true);
    expect(selection.isWheelNavigationObject('unknown')).toBe(false);
    expect(supportsCatalogWheelNavigation).toHaveBeenCalledWith('hyg-3229');
