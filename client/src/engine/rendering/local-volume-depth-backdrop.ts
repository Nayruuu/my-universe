...
// Keep one fixed, direction-preserving depth field present throughout the long Local Group to
// Nearby Universe passage. Previously this shell ended at 55,000 scene units: the camera could
// cross an almost empty interval around 60,000 before the outer catalogue layers were legible.
// These thresholds affect only the layer opacity, never the camera transform or the source
// coordinates.
const FADE_IN_START_DISTANCE = 4_800;
const FULL_OPACITY_DISTANCE = 12_000;
const FADE_OUT_START_DISTANCE = 95_000;
const FADE_OUT_END_DISTANCE = 150_000;
const MAXIMUM_OPACITY = 0.46;
const OPACITY_DAMPING = 4;
const DEPTH_SHELL_INNER_RADIUS = 22_000;
const DEPTH_SHELL_OUTER_RADIUS = 140_000;
...
export class LocalVolumeDepthBackdrop {
  ...
  constructor(
    ...
    this.points.userData['referenceFrame'] = 'nearby-universe';
