...
import { type GraphicQuality, type SpaceTileIndex } from '../../data/models/universe.models';
...
export class CosmicCatalogLayers {
  ...
  public async setTempelFilamentSpineCatalog(
    ...
    this.tempelFilamentSpineBatch.setPhotographicRadiance(this.photographicRadiance);
    this.root.add(this.tempelFilamentSpineBatch.root);
  }
