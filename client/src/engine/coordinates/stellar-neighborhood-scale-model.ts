...
export const STELLAR_NEIGHBORHOOD_EXPANSION_START = 420;
export const STELLAR_NEIGHBORHOOD_EXPANSION_END = 3_600;
export const STELLAR_NEIGHBORHOOD_REVEAL_START = 520;
export const STELLAR_NEIGHBORHOOD_REVEAL_END = 1_100;
...
/**
 * Continuous visual reveal of the heliocentric catalogue while travelling from the galactic disc
 * to the local stellar map. It is illustrative: physical positions remain documented, while this
 * factor prevents a compressed catalogue from reading as a second galaxy.
 */
