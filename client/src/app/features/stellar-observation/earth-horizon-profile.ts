...
export function createEarthHorizonProfile(location: EarthObserverLocation): EarthHorizonProfile {
  ...
  return {
    location,
    farRidgeClipPath:
      cityscape?.farRidgeClipPath ?? createSkylineClipPath(seed ^ 0x51f2_a84d, 61, 16),
    nearRidgeClipPath:
      cityscape?.nearRidgeClipPath ?? createSkylineClipPath(seed ^ 0x9e37_79b9, 69, 24),
    ...
    lightDensity: cityscape?.lightDensity ?? 'balanced',
    landmark: definition
      ? {
