...
Un presupuesto superado ya no detiene los protocolos posteriores: el manifiesto completo marca cada
protocolo, perfil y campaña con `withinBudget`, y después el modo estricto devuelve el fallo.
`UNIVERSE_BENCHMARK_STRICT=0` solo sirve para recopilar deliberadamente una línea base ya conocida
como regresiva.
