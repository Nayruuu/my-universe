...
The panel and the scale-journey benchmark also report initial-rendering and Tempel-scene warmup.
Each value is a monotonic wall-clock duration for preparation requested from Three.js. It helps
relate a frame spike to shader or texture work, but does not claim to measure GPU execution time.
