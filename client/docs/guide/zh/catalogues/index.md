...
| 恒星目录       |                    10,000颗HYG恒星 | J2000观测位置与速度；线性传播限制在±10,000儒略年范围内               |
| Gaia恒星层级   | 2,923,790个输入；133,526个实测样本 | 512秒差距计算聚合；J2016.0实测样本；不完整背景                       |
...
- 质量筛选混合恒星背景：[Gaia Data Release 3](https://www.cosmos.esa.int/web/gaia/data-release-3)
  `gaia_source_lite`；
