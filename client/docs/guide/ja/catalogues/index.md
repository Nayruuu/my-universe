...
| Gaia恒星階層       | 入力2,923,790件、実測サンプル133,526件 | 計算済み512 pc集約、実測J2016.0サンプル。不完全な背景                                |
...
- 品質条件付きハイブリッド恒星背景の[Gaia Data Release 3](https://www.cosmos.esa.int/web/gaia/data-release-3)
  `gaia_source_lite`；
