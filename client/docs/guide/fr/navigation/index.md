...
Le zoom suit le pointeur. Sans cible, la caméra avance tout de même vers le point sous le curseur. À
proximité d’un corps, des limites empêchent de traverser involontairement sa surface visible.
...
- la **cible** est le pivot de la caméra ;
